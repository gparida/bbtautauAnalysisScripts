...
parser.add_argument('--basePath',help="Enter the dir path inside which thhere are  crab- directories",required=True)
...
for obj in base_path.iterdir():
    ...
    if "crab_" in obj.name:
        ...
        print("Comamnd to Execute = ",f'crab resubmit {base_path/obj.name}')
