...
static constexpr auto s_tag = "[boostedTauRecoFilter]";

TEST_CASE("Standard checks of boostedTauRecoFilter", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDFilter("boostedTauRecoFilter"
