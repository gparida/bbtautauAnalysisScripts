...
static constexpr auto s_tag = "[boostedTopologyIsoCorrectionTool]";

TEST_CASE("Standard checks of boostedTopologyIsoCorrectionTool", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("boostedTopologyIsoCorrectionTool"
