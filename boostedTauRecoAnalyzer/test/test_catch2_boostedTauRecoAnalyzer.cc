...
static constexpr auto s_tag = "[boostedTauRecoAnalyzer]";

TEST_CASE("Standard checks of boostedTauRecoAnalyzer", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("boostedTauRecoAnalyzer"
