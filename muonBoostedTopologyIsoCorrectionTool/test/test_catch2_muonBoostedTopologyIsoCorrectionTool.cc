...
static constexpr auto s_tag = "[muonBoostedTopologyIsoCorrectionTool]";

TEST_CASE("Standard checks of muonBoostedTopologyIsoCorrectionTool", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("muonBoostedTopologyIsoCorrectionTool"
