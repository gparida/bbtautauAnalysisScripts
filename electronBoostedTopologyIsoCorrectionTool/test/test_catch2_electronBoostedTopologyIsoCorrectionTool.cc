...
static constexpr auto s_tag = "[electronBoostedTopologyIsoCorrectionTool]";

TEST_CASE("Standard checks of electronBoostedTopologyIsoCorrectionTool", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("electronBoostedTopologyIsoCorrectionTool"
