...
Electron_IsoCompForTausColl electronBoostedTopologyIsoCorrectionTool::compElectron_IsoCompForTausColl( double rho, int index,  edm::Handle<std::vector<pat::Electron>> electronCollection, edm::Handle<std::vector<pat::Tau>> boostedTauCollection)
{
...
Muon_IsoCompForTausColl electronBoostedTopologyIsoCorrectionTool::compMuon_IsoCompForTausColl (int index, edm::Handle<std::vector<pat::Muon>> muonCollection, edm::Handle<std::vector<pat::Tau>> boostedTauCollection)
{
